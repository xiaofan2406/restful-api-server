...
context('/api/article', function() {
  ...
  describe('PATCH /:id', function() {
    ...
    context('with correct request data', function() {
      ...
      it('update the database with request data', function(done) {
        ...
        .then(arti => {
          updatedArticle = arti;
          for (const key of Object.keys(articleUpdates)) {
  ...
  describe('DELETE /:id', function() {
    ...
    context('with correct request data', function() {
      ...
      it('paranoid "delete" article in the database', function(done) {
        ...
        .then(deletedArticle => {
          expect(deletedArticle.deleteAt).to.not.be.null;
          done();
        })
        .catch(error => {
          done(error);
  ...
  describe('GET /:id', function() {
    context('with correct request data', function() {
      it('return 200 with article selfie and author publicSnapshot ' +
      'for public when token user is author', function(done) {
      ...
      it('return 200 with article selfie and author publicSnapshot ' +
      'for public when token user is not author', function(done) {
        const author = sampleUsers[1];
        const article = sampleArticles[3];
        axios.get(`${ARTICLE_API}/${article.id}`, {
      ...
      it('return 200 with article selfie and author publicSnapshot ' +
      'for private when token user is author', function(done) {
        const author = sampleUsers[1];
